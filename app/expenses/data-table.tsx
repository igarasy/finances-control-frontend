...
export function DataTable<TData, TValue>({
  ...
  return (
    <div className="text-slate-300">
      ...
      <p className="flex items-center justify-center text-7xl">Gastos</p>
      <div className="flex items-center py-4">
        <Input
          placeholder="Filtrar gastos..."
          value={
            (table.getColumn('expense')?.getFilterValue() as string) ?? ''
          }
          onChange={(event) =>
        ...
        <Button className="ml-auto bg-slate-700 hover:bg-slate-600">
          <Link href={'expenses/create'}>Adicionar gasto</Link>
        </Button>
